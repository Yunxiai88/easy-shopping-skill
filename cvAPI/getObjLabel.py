...
TEST_IMAGE_PATH = '/home/iss-user/mycroft-core/skills/easy-shopping-skill/testPhoto/test.jpg'
if MYCROFT_VERSION:
...
if not MYCROFT_VERSION:
    print('getObjLabel start------', time.time())
    a = getObjectsThenLabel(TEST_IMAGE_PATH)
    print(a)
    print('getObjLabel end-------', time.time())
